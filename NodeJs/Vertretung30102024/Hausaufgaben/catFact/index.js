...
async function showCatFact() {
  ...
  const CatBox = boxen(chalk.red(fact), {
    padding: 1, // Mit chalk wird aufgerufen und das Zitat Rot angezeigt.
    margin: 1,
    borderStyle: "double",
  });
...
async function askForNewQuote() {
  ...
  // 2. Wenn der Benutzer "Nein" wählt, beende das Programm test
